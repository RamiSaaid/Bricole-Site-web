...
<?php
    ...
    if (isset($_SESSION['message'])) {
        echo "<div style='background-color: green; color: white; padding: 10px; text-align:center;'>" . $_SESSION['message'] . "</div>";
...
?>
            ...
            <div class="section-container">
                ...
                <a href="edit_profile.php" class="button">Modifier le profil</a>
            </div>
            <div class="section-container">
                <h2><i class="fas fa-clipboard-list"></i>
Vos offres d'emploi</h2>
                <a href="view_jobs.php" class="button">Voir mes offres</a>
            </div>
            <div class="section-container">
                <h2><i class="fas fa-plus-circle"></i>Publier une nouvelle offre d'emploi</h2>
                <a href="post_job.php" class="button">Publier une offre</a>
            </div>
            <div class="section-container">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="bricole.php#recherche">Recherche</a></li>
                                <li><a href="bricole.php#mecanisme">Mécanisme</a></li>
                                <li><a href="bricole.php#faq">Qui sommes-nous ?</a></li>
                                <li><a href="bricole.php#transparence">Transparence</a></li>
                                 <!-- <li><a href="#">Recherche33</a></li>  -->
                                <li><a href="bricole.php#evaluations">Évaluations</a></li>
                               <!--  <li><a href="#">Expert Team</a></li>  -->
                                <li><a href="bricole.php#partners">Nos Partenaires</a></li>
